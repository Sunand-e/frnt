...
// export default function Library({text,type,tag}) {
export default function Library({queries}) {
  ...
  useEffect(() => {
    if(data) {
      ...
      latestContentVar(libraryVar().slice(0, 3))
  ...
  return (
    <>
      ...
      <PageTitle
        title={`Library`}
        subtitle='Take a look through our library of courses and resources'
      />
      <PageContent>
