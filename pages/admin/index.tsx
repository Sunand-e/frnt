    ...
    // </>
      <main className="flex-1 pb-8">
        ...
        <div className="mt-8">
          ...
          <h2 className="col-span-12 lg:col-span-8 mt-8 text-lg leading-6 font-medium text-gray-900">
            Recent activity
          </h2>
          ...
          <div className="hidden sm:block col-span-12 lg:col-span-8">
            ...
            <div className="col-span-12 lg:col-span-4 flex-none lg:block md:flex ">
              ...
              <div className="bg-white shadow rounded-md p-4 w-full lg:w-full md:w-1/2">
                <QuickActions key="d" />
              </div>
