...
export interface CreateSection_createSection_section_mediaItem {
  __typename: "MediaItem";
  id: string;
...
export interface CreateSection_createSection_section_children_mediaItem {
  __typename: "MediaItem";
  id: string;
  mediaType: string | null;
  location: string | null;
...
export interface CreateSection_createSection_section_children {
  ...
  itemType: string;
  mediaItem: CreateSection_createSection_section_children_mediaItem | null;
...
export interface CreateSection_createSection_section {
  ...
  itemType: string;
  mediaItem: CreateSection_createSection_section_mediaItem | null;
  prerequisites: any | null;
  title: string | null;
  updatedAt: any;
