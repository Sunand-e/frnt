...
export interface BlockContainerStyleProps extends BlockContainerProps {
...
export interface BlockContainerStyles {
  /**
   * Block and gutter.
   */
...
export interface BlockContainerProps
  extends StyledElementProps<{}, BlockContainerStyles> {
  componentRef?: any;
