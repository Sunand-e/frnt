              ...
              <li className={``} key={index}>
                {
                  ...
                  : (
                      (<Link
                        href={item.link}
                        className={`${menuItemClasses} h-16 mb-2 rounded-2xl flex items-center hover:bg-black hover:bg-opacity-5 space-x-4 px-3 transition-colors duration-200 text-lg`}
